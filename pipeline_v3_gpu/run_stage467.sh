#!/bin/bash
#SBATCH --job-name=v22_stg467
#SBATCH --partition=fat
#SBATCH --gres=gpu:1
#SBATCH --time=01:00:00
#SBATCH --output=v22_stage467_%j.log
#SBATCH --error=v22_stage467_%j.err
...
# Delete Stage 4 + 6 + 7 cache (force re-run)
rm -f outputs_v2_2/A0/keyword_alignment.csv
rm -f outputs_v2_2/A0/segment_alignment.csv
rm -f outputs_v2_2/A0/diagnostics/stage4_alignment.json
...
echo ""
echo "=== Pipeline v2.2 — Stage 4 (Alignment, scene-OCR-union fix) ==="
echo "Time: $(date)"
...
echo ""
echo "=== Stage 4: Keyword Alignment (first 30 lines) ==="
head -30 outputs_v2_2/A0/keyword_alignment.csv
echo ""
echo "=== Stage 4: Segment Alignment ==="
...
echo ""
echo "=== Keyword Scores (first 30 lines) ==="
head -30 outputs_v2_2/A0/keyword_scores.csv
echo ""
echo "=== Segment Scores ==="
