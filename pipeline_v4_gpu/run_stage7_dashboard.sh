#!/bin/bash
#SBATCH --job-name=v22_stg7dash
#SBATCH --partition=fat
#SBATCH --gres=gpu:1
#SBATCH --time=00:20:00
#SBATCH --output=v22_stage7dash_%j.log
#SBATCH --error=v22_stage7dash_%j.err
...
# Delete Stage 7 cache (force re-run)
...
rm -f outputs_v2_2/A0/report_dashboard.html
...
echo ""
echo "=== Pipeline v2.2 — Stage 7 (Scoring + Dashboard) ==="
echo "Time: $(date)"
...
ls -la outputs_v2_2/A0/report_dashboard.html 2>/dev/null && echo "YES" || echo "NO"
